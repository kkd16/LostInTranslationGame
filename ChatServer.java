...
class Translator {
    static String translate(String langFrom, String langTo, String text) throws IOException {
        // INSERT YOU URL HERE
        String urlStr = "https://script.google.com/macros/s/AKfycbx7qkldlo_GB8v3_OBy52sx6v1Hfc9ClJ3QeWwpUPKE_k9SJeK8cNuHVEAGPt0a-lGu0g/exec" +
...
class ChangeLanguage{
    static String randomizer(String message) throws IOException {
        ...
        String[] SecondGrouplanguages = {"sm", "jp", "te", "th", "ug", "vi", "ru"};
